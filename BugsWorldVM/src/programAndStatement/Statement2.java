...
public class Statement2 extends StatementSecondary {
    ...
    private void createNewRep() {
        ...
        /*
         * this.rep is a tree with BLOCK at the root and empty subtrees children
         */
        this.rep = new Tree1<>();
    ...
    public final Kind kind() {
        ...
        /*
         * disassemble this.rep, the root is the statement label, which consists
         * the kind of statement this.rep
         */
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
    ...
    public final void addToBlock(int pos, Statement s) {
        ...
        /*
         * Disassemble this.rep and add localS.rep to the corresponding position
         */
        StatementLabel label = this.rep.disassemble(children);
        children.add(pos, localS.rep);
        /*
         * Assemble this.rep so it contains the updated subtrees
         */
        this.rep.assemble(label, children);
        /*
         * clear s
    ...
    public final Statement removeFromBlock(int pos) {
        ...
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        /*
         * Disassemble this.rep and remove the subtree at the corresponding
         * position
         */
        StatementLabel label = this.rep.disassemble(children);
    ...
    public final int lengthOfBlock() {
        assert this.kind() == Kind.BLOCK : ""
                + "Violation of: [this is a BLOCK statement]";
        /*
         * Return the number of statements in this.rep, which is the same as
         * returning the number of subtrees
         */
    ...
    public final void assembleIfElse(Condition c, Statement s1, Statement s2) {
        ...
        /*
         * The kind of root will be IF_ELSE and the children will be the two
         * statements
         */
    ...
    public final Condition disassembleIfElse(Statement s1, Statement s2) {
        ...
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        /*
         * Disassemble this.rep and remove the first two subtrees
         */
        StatementLabel label = this.rep.disassemble(children);
        localS1.rep = children.remove(0);
        /*
         * After removing the first subtree, the "second" subtree will be at
         * position 0
         */
    ...
    public final void assembleWhile(Condition c, Statement s) {
        ...
        Statement2 localS = (Statement2) s;
        /*
         * The kind of root will be WHILE and the child will be the statement
         */
    ...
    public final Condition disassembleWhile(Statement s) {
        ...
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        /*
         * Disassemble this.rep and remove the first subtree
         */
        StatementLabel label = this.rep.disassemble(children);
        localS.rep = children.remove(0);
        /*
    ...
    public final void assembleCall(String inst) {
        ...
        /*
         * The kind of root will be CALL and itself has no children
         */
        StatementLabel label = new StatementLabel(Kind.CALL, inst);
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        /*
         * Assemble this.rep so it is updated
         */
        this.rep.assemble(label, children);
    ...
    public final String disassembleCall() {
        ...
        /*
         * Disassemble this.rep and return the instruction of the CALL
         */
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        StatementLabel label = this.rep.disassemble(children);
        /*
